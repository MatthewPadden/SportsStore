...
namespace SportsStore.Domain.Concrete
{
    public class EmailSettings
    {
        ...
        public string Pasword = "MySmtpPassword";
        public string ServerName = "smtp.example.com";
        public int ServerPort = 587;
        public bool WriteAsFile = true;
        public string FileLocation = @"D:\My Profile\Documents\GitHub\SportsStore\Orders";
    }
    ...
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                smtpClient.Credentials = new NetworkCredential(emailSettings.Username, emailSettings.Pasword);
